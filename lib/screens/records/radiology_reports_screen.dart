                      ...
                      ? ListView(
                          ...
                          children: const [
                            ...
                            EmptyStateWidget(
                              ...
                              message: 'Imaging reports will appear here after your scans.',
                            ),
                          ],
                        )
                      : ListView(
                          ...
                          children: [
                            ...
                            ..._reports.map((report) {
                              ...
                              return HealthReportListCard(
                                ...
                                subtitle: report.radiologist != null ? 'Radiologist: ${report.radiologist}' : null,
                                preview: preview,
                                meta: [
                                  if (report.orderNumber != null) 'Order ${report.orderNumber}',
                                  if (report.displayDate != null) report.displayDate!,
                                ].join(' · '),
                                statusLabel: hasReport ? 'Final' : 'Pending',
                                statusColor: hasReport ? PunjabColors.success : PunjabColors.warning,
